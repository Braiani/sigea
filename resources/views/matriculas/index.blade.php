                    ...
                    <div class="col-sm-12">
                        <div class="card card-tasks">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="cota_candidato" readonly
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="cota_ingresso" readonly
                                                               class="form-control disabled">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <p class="text-muted">Será enviado informações sobre a matrícula para
                                                    este e-mail</p>
                            ...
                            <div class="card-footer ">
                                <hr>
                                <div class="stats">
                                    <button id="btn-submit" type="submit" hidden form="form-matricula"
                                            class="btn btn-success">Salvar
                                    </button>
                                    <button id="reclassificacao" type="button" hidden class="btn btn-danger">
                                        Reclassificação
                                    </button>
                                </div>
                            </div>
            ...
            $("#candidato").on('change', function () {
                ...
                if (candidato['chamada'] != null) {
                    if (candidato['status_matricula_id'] == null) {
                        if (candidato['chamada'] < {{ $chamada }}) {
                            clearCampos();
                            return Swal(
                                'Erro!',
                                'Candidato convocado em chamada anterior!',
                                'error'
                            );
                        }
                        $.ajax({
